    ...
    it("create Ticket Termination",()=> {
        cy.request({
            ...
            body : {
                ...
                "requestTypeCode": employeeTermination.requestTypeCodeResign,
                "requestTypeCodeDetail": employeeTermination.requestTypeCodeDetailResign
            }
        }).then((res)=>{
                expect(res.status).to.eq(200)
    ...
    it("add Item To Ticket",()=> {
        cy.request({
            ...
            body : {
                ...
                "reasons": [
                  {
                    "reasonCode": employeeTermination.reasonCodeResign 
                  }
                ]
              }
        }).then((res)=> {
